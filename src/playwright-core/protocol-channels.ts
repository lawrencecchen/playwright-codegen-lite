...
export interface DebugControllerEventTarget {
	...
	on(
		event: "stateChanged",
		callback: (params: DebugControllerStateChangedEvent) => void
	): this;
	on(
		event: "sourceChanged",
		callback: (params: DebugControllerSourceChangedEvent) => void
	): this;
	on(
		event: "paused",
		callback: (params: DebugControllerPausedEvent) => void
	): this;
	on(
...
export interface DebugControllerChannel
	...
	navigate(
		...
		metadata?: Metadata
	): Promise<DebugControllerNavigateResult>;
	setRecorderMode(
		params: DebugControllerSetRecorderModeParams,
		metadata?: Metadata
	): Promise<DebugControllerSetRecorderModeResult>;
	highlight(
		params: DebugControllerHighlightParams,
		metadata?: Metadata
	): Promise<DebugControllerHighlightResult>;
	hideHighlight(
		params?: DebugControllerHideHighlightParams,
		metadata?: Metadata
	): Promise<DebugControllerHideHighlightResult>;
	resume(
		params?: DebugControllerResumeParams,
		metadata?: Metadata
	): Promise<DebugControllerResumeResult>;
	kill(
